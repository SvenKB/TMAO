...
fit_sem <- lavaan::sem(model=model,data=data1,estimator="MLMVS")
...
semPlot::semPaths(fit_sem,"std",title = T)

fit_sem_gender <- lavaan::sem(model=model,data=data1,estimator="MLMVS",group="gender")

lavaan:::summary(fit_sem_gender,standardize=T)
